...
public class Conversions {
    ...
    public static double countsPerRev = 1;
    ...
    public static double falconToRadians(double counts){
        return counts * (twoPi / (DriveConstants.turnGearRatio * countsPerRev));
    }
    ...
    public static double falconToDegrees(double counts){
        return counts * (360.0 / (DriveConstants.turnGearRatio * countsPerRev));
    }
    ...
    public static double radiansToFalcon(double radians){
        return radians / twoPi * (DriveConstants.turnGearRatio * countsPerRev);
    }

    public static double degreesToFalcon(double degrees){
        return degrees / (360 / (DriveConstants.turnGearRatio * countsPerRev));
    }
    /**
    ...
    public static double falconToRPM(double velocitycounts)
    {
        ...
        double motorRPM = velocitycounts * (600.0 / countsPerRev);
    ...
    {
        double distanceMeters = positionCounts / countsPerRev / DriveConstants.driveGearRatio * DriveConstants.wheelCircumfrence;
